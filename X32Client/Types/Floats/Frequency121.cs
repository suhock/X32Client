...
{
    public class Frequency121 : Frequency
    {
        ...
        protected Frequency121() { }

        public Frequency121(float unitValue) : base(unitValue) { }

        public Frequency121(int stepValue) : base(stepValue) { }

        public static Frequency121 FromEncodedValue(float encodedValue) =>
            new Frequency121() { EncodedValue = encodedValue };
    }
}
